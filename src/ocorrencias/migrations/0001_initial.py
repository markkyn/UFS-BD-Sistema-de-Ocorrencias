...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='ocorrencia',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ocorrencias.ocorrencia'),
        ),
        migrations.AddField(
            model_name='atendimento',
            name='operadores',
            field=models.ManyToManyField(to='common.operacional'),
        ),
    ]
